--
-- Dynamic bArchTi Theme Menu for Elephant/Walker
--
Name = "barchtithemes"
NamePretty = "bArchTi Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/barchti/themes"
  local barchti_path = os.getenv("BARCHTI_PATH") or ""
  local default_theme_dir = barchti_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "barchti-theme-set " .. theme_name,
            },
          })
        end
      end
